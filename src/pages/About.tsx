      ...
      <div className="container mx-auto px-4">
        ...
        <section className="mb-20">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Les passionnés qui donnent vie à WXLLSPACE au quotidien
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {team.map((member, index) => (
              <Card key={index} className="elevated transition-smooth hover:shadow-glow-accent text-center">
                <CardHeader>
        ...
        <section className="mb-20">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Les étapes clés de l'aventure WXLLSPACE
            </p>
          </div>

          <div className="relative">
            <div className="absolute left-1/2 transform -translate-x-0.5 w-1 h-full bg-gradient-to-b from-primary to-secondary rounded-full opacity-30"></div>

            <div className="space-y-12">
              {milestones.map((milestone, index) => (
                <div key={index} className="flex items-center gap-8">
                  <div className={`${index % 2 === 0 ? 'order-1' : 'order-3'} flex-1 text-${index % 2 === 0 ? 'right' : 'left'}`}>
                    <Card className="elevated inline-block max-w-md transition-smooth hover:shadow-glow-primary">
                      <CardContent className="p-6">
                        <Badge className="bg-gradient-primary text-white border-0 mb-3">
                          {milestone.year}
                        </Badge>
                  ...
                  <div className="order-2 w-6 h-6 bg-gradient-primary rounded-full border-4 border-background z-10 animate-glow-pulse"></div>
